...
class _NewTaskScreenState extends State<NewTaskScreen> {
                ...
                child: RefreshIndicator(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return TaskCard(taskItem: _taskListWrapper!.taskList![index]);
                    },
                  ),
                ),
              ),
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            return TaskCounterCard(
                amount: _countByStatusWrapper?.listOfTaskByStatusData![index].sum,
                title:
  ...
  Future<void> _getAllTaskCountByStatus() async {
    ...
    if(response.isSuccess){
      ...
      setState(() {});
      if(mounted){
        showSnackBarMessage(context, response.errorMassage ?? 'Get task count by status has been field' );
      }
    }
  ...
  Future<void> _getNewTaskList() async{
    ...
    if(response.isSuccess){
      ...
      setState(() {});
      if(mounted){
        showSnackBarMessage(context, response.errorMassage ?? 'Get new task list has been field' );
      }
    }
